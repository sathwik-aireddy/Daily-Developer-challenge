...
# DAILY DEVELOPER CHALLENGE - DAY 2
...
#
# Approach A:
# Sort the list and pick the second largest.
#
# Time Complexity: O(n log n)
#
# Approach B:
# Traverse the list and track the largest and second largest.
#
# Time Complexity: O(n)
#
# Which approach is more efficient?
#
# Approach B is more efficient because it only needs one
# traversal of the list.
#
# What would happen if the list contained 1 million numbers?
#
# Sorting would require more operations because all the
# numbers need to be sorted.
#
# The traversal approach would process the numbers once,
# making it more efficient for a very large list.
#
...
#
# Today I learned how to find the second largest unique
# number without sorting a list.
#
# I learned the difference between mutable and immutable
# objects in Python.
#
# I also learned how assignment between lists works and
# how to create an independent copy.
#
# I learned how to identify and fix a logical error in a
# loop.
#
#
# What was difficult?
#
# Finding the second largest unique number was slightly
# difficult because duplicate values need to be handled.
#
# Understanding why b = a changes the original list was
# also useful for understanding mutable objects.
#
#
...
# I will practice:
#
# 1. Finding the largest and second largest numbers.
# 2. Working with lists and dictionaries.
# 3. Mutable and immutable objects.
# 4. break and continue.
# 5. Debugging loops and logical errors.
